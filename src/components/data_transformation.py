...
class DataTransformation:
    ...
    def get_data_transformation_object(self):
        try:
            ...
            categorical_feature = ['job', 'Qualification','Marital-Status','occupation','relationship','Colour','Gender','City']
            numerical_feature = ['age', 'education-num','capital-gain', 'hours-per-week']
